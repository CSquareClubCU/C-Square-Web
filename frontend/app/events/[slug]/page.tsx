        ...
        <div className="flex flex-col lg:flex-row gap-10 xl:gap-16 items-start">
              ...
              <div id="faqs" className="mb-12 pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="bg-[#ffffff] border border-[#e5e7eb] rounded-[12px] p-6 shadow-sm flex flex-col justify-between">
                    ...
                    <p className="text-[#374151] mt-6 text-[15px]">
                      {event.registration_fee && event.registration_fee > 0 ? `₹${event.registration_fee} ${event.is_fee_per_team ? 'per team' : 'per person'}` : 'Free for all students.'}
                    </p>
                  </div>
                </div>
          ...
          <div className="w-full lg:w-[340px] xl:w-[380px] shrink-0 flex flex-col self-stretch order-1 lg:order-2">
            ...
            <div className={`bg-[#ffffff] rounded-[12px] border border-[#e5e7eb] shadow-sm p-6 md:p-8 ${showTeamSection ? '' : 'lg:sticky lg:top-[120px] lg:max-h-[calc(100vh-140px)] lg:overflow-y-auto mb-12'}`}>
                  ...
                  ) : event.external_registration_url && canRegister ? (
                  ...
                  <div className="mt-8 pt-6 border-t border-[#e5e7eb]">
                    <p className="text-[11px] font-semibold text-[#898989] uppercase tracking-widest mb-4 text-center">Sponsors</p>
                    <div className="flex items-center justify-center gap-6">
                      ...
                      <img src="/CTSOC.png" alt="IEEE CTSoc" className="h-14 w-auto object-contain" />
                    </div>
                  </div>
