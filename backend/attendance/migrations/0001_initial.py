    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('check_in_method', models.CharField(blank=True, choices=[('qr', 'QR'), ('manual', 'Manual')], max_length=10, null=True)),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['event'], name='attendance__event_i_277a91_idx'), models.Index(fields=['is_checked_in'], name='attendance__is_chec_39a8ac_idx')],
            },
        ),
    ]
